...
/* ─────────────────────────────────────────────
   LANYARD HOOK — real-time Discord / Spotify
───────────────────────────────────────────── */
...
function SpotifyCard() {
  const DISCORD_ID = "295136901436932098"; // ← замени на свой Discord ID
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: 6,
          border: "1px solid rgba(80,250,123,0.14)",
          fontSize: 10,
        }}
      >
...
function GrpcMock() {
  return (
    ...
    >
      <div style={{ color: "rgba(255,255,255,0.22)", marginBottom: 4 }}>// service.proto</div>
      <div>
...
useEffect(() => {
  setTime(new Date()); // первый рендер только на клиенте
          ...
          >
                ...
                {["Server-Worker", "Goroutines", "Channels", "Non-blocking"].map((t) => (
                  <span
                    ...
                    style={{
                      ...
                      border: "1px solid rgba(0,172,215,0.2)",
                      color: "#00acd7",
                    }}
                  >
                    {t}
            ...
            <div
              ...
              style={{
                ...
                borderRadius: 20,
                padding: 22,
                animation: "slideIn 0.5s ease both 0.34s",
              }}
            >
            ...
            >
              ...
              {/* Progress bar — 6 of 9 trimesters = 66.6% */}
              <div>
                <div
                  style={{
                    height: 3,
                ...
                >
                  <div
                    style={{
                      width: "66.6%",
                      height: "100%",
                      background: "linear-gradient(to right, #63b3ff, #9b59b6)",
                      borderRadius: 2,
                    }}
                  />
                </div>
              ...
              <div
                style={{ fontSize: 11.5, color: "rgba(255,255,255,0.3)", fontStyle: "italic" }}
              >
